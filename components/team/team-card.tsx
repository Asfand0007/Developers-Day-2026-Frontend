    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 p-4 pt-8 sm:p-6 sm:pt-12 flex flex-col h-[160px] sm:h-[180px]">
          <p
            className={`text-sm sm:text-base font-mono uppercase tracking-wider mb-1 ${roleColorClass}`}
          >
            {role}
          </p>
      ...
      {showModal && (
        ...
        >
          ...
          <div
            ...
            role="presentation"
            style={{
              boxShadow: `0 0 40px ${accentColor}22, 0 25px 50px rgba(0,0,0,0.6)`,
            }}
          ...
          >
            ...
            <p className="text-gray-400 text-sm font-mono">
              Some legends donot need a profile. You already know the name.
            </p>
