...
//       {/* Corner Accents */}
//       <div className="absolute top-0 left-0 w-6 h-6 border-t-4 border-l-4 border-red-primary" />
...
//         </span>
//       </div>
//       <div className="absolute bottom-0 left-0 w-6 h-6 border-b-4 border-l-4 border-red-primary" />
//       <div className="absolute bottom-0 right-0 w-6 h-6 border-b-4 border-r-4 border-red-primary" />
